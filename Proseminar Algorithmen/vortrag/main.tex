...
\begin{frame}[allowframebreaks]{Outline}
  \tableofcontents[currentsection,hideallsubsections,shrink,pausesections]
...
% eventuell wenn Vorraussetzungen zu lang werden
% \subsection{Zusammenfassung}


%eventuell noch unter Vorraussetzungen
