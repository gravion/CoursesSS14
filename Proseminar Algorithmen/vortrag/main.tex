...
\uncover<3-> { \item d.h : Wenn ein Algorithmus eine Eingabefolge nicht sortiert, so sortiert er trotzdem alle 0,1-Folgen. }
...
\uncover<4-> {\item unsortierte Ausgabefolge $U \; = \; u_0 … u_N$}
...
%        \begin{itemize}
%            \item hohe Geschwindigkeit durch direkte Hardware Implementierung
